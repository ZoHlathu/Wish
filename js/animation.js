...
const config = {
    ...
    pic: "https://telegra.ph/RSR-11-28", //image url of recipients (Mandatory)
...
CTAtext.innerHTML = "Bulb hi hmet rawh.";
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        light.play();
        transition(darkroom);
        CTAtext.innerHTML = "Kawngkhar hi hmet rawh.";
        setTimeout(function() {
        ...
        */
        ...
        door.play();
        transition(hallway);
        CTAtext.innerHTML = "Gift box hi hmet rawh.";
        setTimeout(function() {
